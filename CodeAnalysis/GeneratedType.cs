...
namespace RhoMicro.CodeAnalysis
{
	...
	{
		public GeneratedType(TypeIdentifier identifier, SyntaxNode source) : this(identifier, new GeneratedSource(source, identifier.Name.ToString()))
		{
		}
		public GeneratedType(TypeIdentifier identifier, String source) : this(identifier, new GeneratedSource(source, identifier.Name.ToString()))
		{
		}
